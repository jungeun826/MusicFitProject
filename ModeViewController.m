...
- (IBAction)moveToPlayerView:(id)sender {
...
//    [UIView animateKeyframesWithDuration:0.5 delay:0.2 options:UIViewKeyframeAnimationOptionAutoreverse animations:^{
//        NSLog(@"changed root - player");

//    } completion:nil];
	PlayViewController *nextVC =(PlayViewController *)[self.storyboard instantiateViewControllerWithIdentifier:@"player"];
 
    CGPoint toPoint = viewsContainer.contentOffset;
	toPoint.x = 2 * viewsContainer.bounds.size.width;
    
    [viewsContainer addSubview:nextVC.view];
//	
//	if (nextVC == nil)
//		return;
//	
...
//
        ...
        [UIView animateWithDuration:0.5
                         ...
                         animations:^{
                             ...
                             NSLog(@"%f", nextVC.view.frame.origin.x);
                         }
                         completion:^(BOOL completed){
                             ...
                             app.window.rootViewController = nextVC;
                         }];
